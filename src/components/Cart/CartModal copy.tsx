...
export function CartModal() {
  const { cart, cartQuantity, cartTotal, isOpen, openCart, closeCart, toggleCart } = useCart()
  ...
  //   }
  // }, [isOpen, openCart, cartQuantity, pathname])
  ...
  return (
    <Sheet onOpenChange={toggleCart} open={isOpen}>
      <SheetTrigger className="relative flex h-11 w-11 items-center justify-center rounded-md text-gray-500 transition-colors dark:border-neutral-700 dark:bg-black dark:text-white">
